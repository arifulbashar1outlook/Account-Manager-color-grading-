                ...
                <div className="glass rounded-[32px] shadow-2xl w-full max-w-sm overflow-hidden p-8 space-y-6">
                    ...
                    <div className="space-y-4">
                        <div className="relative">
                            ...
                            <input type="text" value={editDesc} onChange={(e) => setEditDesc(e.target.value)} className="w-full px-5 py-3.5 bg-black/5 dark:bg-black/20 rounded-2xl outline-none border border-transparent focus:border-md-primary/30 font-semibold dark:text-white" />
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex items-center bg-black/5 dark:bg-black/20 rounded-2xl overflow-hidden px-5 py-3.5 border border-transparent focus-within:border-md-primary/30 transition-all cursor-pointer">
                                <Clock size={16} className="text-md-primary mr-3 opacity-60" />
                                <input type="datetime-local" value={editDate} onChange={(e) => setEditDate(e.target.value)} className="w-full bg-transparent outline-none font-bold dark:text-white cursor-pointer" />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="relative">
                                ...
                                <input type="number" value={editAmount} onChange={(e) => setEditAmount(e.target.value)} className="w-full px-5 py-3.5 bg-black/5 dark:bg-black/20 rounded-2xl outline-none border border-transparent focus:border-md-primary/30 font-black dark:text-white" />
                            </div>
                            <div className="relative">
                            ...
                            {editType === 'transfer' ? (
                                <>
                                    <div className="relative">
                                        ...
                                        <select value={editAccount} onChange={(e) => setEditAccount(e.target.value)} className="w-full px-5 py-3.5 bg-black/5 dark:bg-black/20 rounded-2xl outline-none font-bold appearance-none dark:text-white">
                                    ...
                                    <div className="relative">
                                        ...
                                        <select value={editTargetAccount} onChange={(e) => setEditTargetAccount(e.target.value)} className="w-full px-5 py-3.5 bg-black/5 dark:bg-black/20 rounded-2xl outline-none font-bold appearance-none dark:text-white">
                                ...
                                <>
                                    ...
                                    <div className="relative">
                                        ...
                                        <select value={editCategory} onChange={(e) => setEditCategory(e.target.value)} className="w-full px-5 py-3.5 bg-black/5 dark:bg-black/20 rounded-2xl outline-none font-bold appearance-none dark:text-white">
                    ...
                    return (
                        <div key={date} className="space-y-4">
                            <div className="flex items-center gap-3 px-3">
                                ...
                                <h3 className="text-[10px] font-medium uppercase tracking-[0.2em] text-md-on-surface-variant opacity-60">{dateObj.toLocaleDateString('en-US', { weekday: 'short', day: 'numeric', month: 'short' })}</h3>
                            </div>
...
const FilterChip: React.FC<FilterChipProps> = ({ label, active, onClick, icon: Icon }) => (
    <button type="button" onClick={onClick} className={`flex items-center gap-2 px-5 py-2.5 rounded-[18px] transition-all text-[10px] font-black uppercase tracking-widest whitespace-nowrap shadow-sm border ${active ? 'bg-md-primary border-md-primary text-white shadow-lg scale-105' : 'glass border-black/5 text-md-on-surface-variant hover:bg-white/80 dark:hover:bg-zinc-800/80 opacity-70'}`}>
