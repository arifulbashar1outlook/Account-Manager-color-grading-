  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="glass p-6 rounded-md-card shadow-sm space-y-6 border border-black/5 dark:border-white/5">
        ...
        {/* Changed background to premium gold (mesh-gradient-primary) */}
        <button
          type="submit"
          className="w-full mesh-gradient-primary text-white font-black py-5 rounded-[24px] shadow-lg hover:shadow-2xl active:scale-95 transition-all text-[11px] uppercase tracking-[0.25em] flex items-center justify-center gap-3 border border-white/20"
        >
